...
'web','api',);
        registerArgumentsSet('routes', 'home','profil-kampus','register',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','dashboard','penelitian.index',
'penelitian.create','penelitian.store','penelitian.show','penelitian.edit','penelitian.update',
'penelitian.destroy','admin.users.index','admin.users.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.users.index','auth.confirm-password','auth.forgot-password','auth.login',
...
'components.text-input','frontend.home','frontend.profil-kampus','layouts.admin','layouts.app',
'layouts.frontend','layouts.guest','layouts.navigation','partials.footer','partials.header',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','laravel-exceptions-renderer::components.badge',
