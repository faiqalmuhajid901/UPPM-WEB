...
<div class="flex justify-between items-center mb-6">
    ...
    {{-- TOMBOL TAMBAH ADMIN --}}
    {{-- Hanya Super Admin yang bisa melihat tombol ini --}}
    @if(auth()->user()->role === 'super_admin')
        <a href="{{ route('admin.users.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg shadow-sm flex items-center text-sm font-medium transition-colors">
