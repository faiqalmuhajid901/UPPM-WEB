...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-6 text-white mb-8 shadow-lg">
        ...
        <p class="text-slate-300 mt-1">Anda login sebagai <span class="font-semibold text-indigo-400">{{ \Illuminate\Support\Str::title(auth()->user()->role) }}</span>.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex items-center hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-slate-800">{{ \App\Models\WebContent::count() }}</h3>
            </div>
        </div>
