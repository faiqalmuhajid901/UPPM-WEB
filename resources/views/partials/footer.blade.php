...
<footer class="relative bg-slate-900 text-gray-200 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/UNIV_ATK.webp') }}" 
             alt="" 
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        ...
        <div class="pb-8 mb-8 border-b border-white/10">
            <div class="text-center md:text-left">
                ...
                <p class="text-gray-400 text-sm mt-1">{{ __('ui.uppm_subtitle') }}</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 pb-8 mb-8 border-b border-white/10">
            ...
            {{-- Profil --}}
            <div>
                <h4 class="text-teal-400 font-bold text-sm uppercase tracking-wider mb-4">{{ __('navbar.profil') }}</h4>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('profil-kampus') }}#tentang" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('navbar.profil_kampus') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('profil-kampus') }}#visi-misi" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('navbar.visi_misi') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('struktur-organisasi') }}" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('ui.tim_kami') }}
                        </a>
                    </li>
            ...
            {{-- Penelitian --}}
            <div>
                <h4 class="text-teal-400 font-bold text-sm uppercase tracking-wider mb-4">{{ __('navbar.penelitian') }}</h4>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('penelitian') }}" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('ui.daftar_penelitian') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('publikasi') }}" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('navbar.publikasi') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('kemitraan') }}" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('navbar.kemitraan') }}
                        </a>
                    </li>
            ...
            {{-- Pengabdian --}}
            <div>
                <h4 class="text-teal-400 font-bold text-sm uppercase tracking-wider mb-4">{{ __('navbar.pengabdian') }}</h4>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('pengabdian') }}" class="footer-link">
                            <i class="fas fa-chevron-right"></i>
                            {{ __('ui.program_pengabdian_footer') }}
                        </a>
                    </li>
                </ul>
            </div>
            ...
            {{-- Kontak --}}
            <div>
                <h4 class="text-teal-400 font-bold text-sm uppercase tracking-wider mb-4">{{ __('ui.kontak') }}</h4>
                <ul class="space-y-3">
            ...
            <div class="flex flex-col items-center justify-start text-center">
                <div class="w-28 h-28 bg-white/5 rounded-2xl p-4 flex items-center justify-center 
                    ...
                    <img src="{{ asset('images/logobaruCMYK.png') }}" 
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex flex-col sm:flex-row items-center gap-2 text-xs text-gray-500">
                <span>&copy; {{ date('Y') }} UPPM Politeknik ATK Yogyakarta.</span>
                <div class="flex items-center gap-3">
                    <a href="{{ route('kontak') }}" class="hover:text-teal-400 transition-colors">{{ __('ui.kontak') }}</a>
                    <span class="text-gray-700">|</span>
                    <a href="{{ route('login') }}" class="hover:text-amber-400 transition-colors">
                        <i class="fas fa-lock mr-1"></i>{{ __('ui.admin') }}
                    </a>
                </div>
            </div>
