{{-- FILE: resources/views/frontend/publikasi/jurnal-bptkspk.blade.php --}}
@extends('layouts.frontend')

@section('title', __('navbar.jurnal_bptkspk'))
...
<div class="pelayanan-page">
    ...
    <section class="pengabdian-hero @if($header && $header->image_url) has-dynamic-bg @endif" @if($header && $header->image_url) data-bg-image="{{ $header->image_url }}" @endif>
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">{{ $header->title ?? __('navbar.jurnal_bptkspk') }}</h1>
            <p class="hero-subtitle">
                {{ $header->excerpt ?? __('navbar.jurnal_bptkspk_desc') }}
            </p>
        ...
        <div class="container">
            ...
            <div class="pelatihan-section">
                <div class="section-header text-center">
                    <span class="section-badge">{{ __('navbar.jurnal_bptkspk') }}</span>
                    <h3 class="section-title text-center">{{ __('navbar.jurnal_bptkspk') }}</h3>
                    <p class="section-subtitle text-center">{{ __('navbar.jurnal_bptkspk_desc') }}</p>
                </div>
                ...
                <div class="pelatihan-grid">
                    ...
                    <div class="pelatihan-card">
                        ...
                        <div class="pelatihan-card__content">
                            <span class="section-badge section-badge--sm">{{ __('navbar.jurnal_bptkspk') }} - {{ $item->created_at->format('Y') }}</span>
                ...
                <div class="empty-state">
                    ...
                    <p class="empty-state__text">{{ __('navbar.jurnal_bptkspk_desc') }}</p>
                </div>
                @endif
            </div>
