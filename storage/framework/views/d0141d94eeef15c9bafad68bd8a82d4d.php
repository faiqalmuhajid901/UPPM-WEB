            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+62274541613" class="text-sm text-gray-400 hover:text-teal-400 transition-colors">
                            (0274) 541613
                        </a>
                    </li>
                    <li class="flex items-center gap-3">
...
<?php /**PATH \\DESKTOP-EQN4087\XAMPP8212\htdocs\uppm-web\resources\views\partials\footer.blade.php ENDPATH**/ ?>