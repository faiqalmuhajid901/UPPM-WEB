...
<?php $__env->startSection('page_title', 'Tambah Konten Baru'); ?>
...
<div class="max-w-4xl mx-auto py-8">
    <div class="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('admin.konten.store')); ?>" enctype="multipart/form-data" class="p-8 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end pt-4 border-t border-slate-200">
                <a href="<?php echo e(request()->headers->get('referer')); ?>" class="bg-white text-slate-700 hover:bg-slate-50 border border-slate-300 font-medium py-2.5 px-5 rounded-lg mr-3">Batal</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\uppm-web\resources\views/admin/konten/create.blade.php ENDPATH**/ ?>