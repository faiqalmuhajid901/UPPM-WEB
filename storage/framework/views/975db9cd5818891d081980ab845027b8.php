        ...
        <?php if($tentang): ?>
            <div class="relative">
                ...
                <div class="bg-white/90 backdrop-blur rounded-[32px] shadow-xl ring-1 ring-gray-100/70 overflow-hidden hover-lift">
                    <div class="profil-about-grid <?php echo e($tentang->image ? 'has-media' : 'no-media'); ?>">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8212\htdocs\uppm-web\resources\views/frontend/profil-kampus.blade.php ENDPATH**/ ?>