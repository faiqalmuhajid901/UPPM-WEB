...
<div class="form-page">
    ...
    <div class="form-card">
        ...
        <form action="<?php echo e(route('admin.content.store', [$section, $category])); ?>" 
              method="POST" 
...
unset($__errorArgs, $__bag); ?>" 
                          placeholder="Ringkasan singkat (opsional)"><?php echo e(old('excerpt')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH \\DESKTOP-EQN4087\XAMPP8212\htdocs\uppm-web\resources\views\admin\konten\create.blade.php ENDPATH**/ ?>