...
<?php $__env->startSection('title', __('navbar.prosiding_semnas')); ?>
...
<div class="pelayanan-page">
    ...
    <section class="pengabdian-hero <?php if($header && $header->image_url): ?> has-dynamic-bg <?php endif; ?>" <?php if($header && $header->image_url): ?> data-bg-image="<?php echo e($header->image_url); ?>" <?php endif; ?>>
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title"><?php echo e($header->title ?? __('navbar.prosiding_semnas')); ?></h1>
            <p class="hero-subtitle">
                <?php echo e($header->excerpt ?? __('navbar.prosiding_semnas_desc')); ?>
        ...
        <div class="container">
            ...
            <div class="pelatihan-section">
                <div class="section-header text-center">
                    <span class="section-badge"><?php echo e(__('navbar.prosiding_semnas')); ?></span>
                    <h3 class="section-title text-center"><?php echo e(__('navbar.prosiding_semnas')); ?></h3>
                    <p class="section-subtitle text-center"><?php echo e(__('navbar.prosiding_semnas_desc')); ?></p>
                </div>
                ...
                <div class="pelatihan-grid">
                    ...
                    <div class="pelatihan-card">
                        ...
                        <div class="pelatihan-card__content">
                            <span class="section-badge section-badge--sm"><?php echo e(__('navbar.prosiding_semnas')); ?> - <?php echo e($item->created_at->format('Y')); ?></span>
                ...
                <div class="empty-state">
                    ...
                    <p class="empty-state__text"><?php echo e(__('navbar.prosiding_semnas_desc')); ?></p>
                </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH \\DESKTOP-EQN4087\XAMPP8212\htdocs\uppm-web\resources\views\frontend\publikasi\prosiding-semnas.blade.php ENDPATH**/ ?>