...
<aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-slate-300 flex flex-col transition-transform duration-300 ease-in-out transform -translate-x-full md:translate-x-0 md:static md:block">
    ...
    <div class="p-4 border-b border-slate-800">
        ...
        <p class="text-sm font-bold text-white mt-1">
            <?php echo e(auth()->user()->role === 'super_admin' ? 'Super Admin' : 'Admin Pegawai'); ?>
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group hover:bg-slate-800 hover:text-white transition-colors">
            <svg class="w-5 h-5 mr-3 text-slate-400 group-hover:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            Lihat Website
        </a>

        
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group hover:bg-slate-800 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-slate-800 text-white border-l-4 border-indigo-500' : ''); ?>">
            <svg class="w-5 h-5 mr-3 text-slate-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            Dashboard
        </a>

        
        <a href="<?php echo e(route('admin.konten.index')); ?>" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group hover:bg-slate-800 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.konten*') ? 'bg-slate-800 text-white border-l-4 border-indigo-500' : ''); ?>">
        ...
        <?php if(auth()->user()->role === 'super_admin'): ?>
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group hover:bg-slate-800 hover:text-white transition-colors <?php echo e(request()->routeIs('admin.users*') ? 'bg-slate-800 text-white border-l-4 border-indigo-500' : ''); ?>">
...
</aside><?php /**PATH E:\laragon\uppm-web\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>