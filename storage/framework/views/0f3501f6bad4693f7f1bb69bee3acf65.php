...
<div class="max-w-7xl mx-auto px-4 py-12">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">Publikasi</h1>
    ...
    <?php else: ?>
        <div class="text-center py-12 bg-gray-100 rounded-lg">
            <p class="text-gray-500 italic">Belum ada data publikasi yang ditampilkan.</p>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\uppm-web\resources\views/frontend/publikasi.blade.php ENDPATH**/ ?>